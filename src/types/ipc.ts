...
export interface ElectronAPI {
  ...
  validateObsidianVault(path: string): Promise<{ success: boolean; validation?: ValidationResult; error?: string }>;
  ...
  saveAudioRecording(audioBuffer: Uint8Array, fileName: string): Promise<APIResponse & { filePath?: string }>;
